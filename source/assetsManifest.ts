  ...
  bundles: [
    ...
    },
    {
      ...
      assets: [
        ...
        { name: "bp", srcs: "assets/teachers/bp.png" },
        { name: "bt", srcs: "assets/teachers/bt.png" },
        { name: "cs", srcs: "assets/teachers/cs.png" },
        { name: "db", srcs: "assets/teachers/db.png" },
        { name: "dr", srcs: "assets/teachers/dr.png" },
        { name: "ew", srcs: "assets/teachers/ew.png" },
        { name: "fv", srcs: "assets/teachers/fv.png" },
        { name: "gk", srcs: "assets/teachers/gk.png" },
        { name: "jk", srcs: "assets/teachers/jk.png" },
        ...
        { name: "lp", srcs: "assets/teachers/lp.png" },
        { name: "mh-1", srcs: "assets/teachers/mh-1.png" },
        { name: "mh-2", srcs: "assets/teachers/mh-2.png" },
        ...
        { name: "rh", srcs: "assets/teachers/rh.png" },
